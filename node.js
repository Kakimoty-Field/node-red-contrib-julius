...
process.env['ALSADEV'] = 'plughw:1,0';
module.exports = function(RED) {
    ...
    function FunctionNode(n) {
        ...
        sandbox.global.set("child_process", require('child_process'));
        sandbox.global.set("__dirname", __dirname);
    ...
    RED.nodes.registerType("julius", FunctionNode);
